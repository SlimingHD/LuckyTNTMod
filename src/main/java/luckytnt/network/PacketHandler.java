...
public class PacketHandler {
	...
	public static void register() {
		...
		CHANNEL.registerMessage(index++, ClientboundDoubleNBTPacket.class, ClientboundDoubleNBTPacket::encode, ClientboundDoubleNBTPacket::new, ClientboundDoubleNBTPacket::handle, Optional.of(NetworkDirection.PLAY_TO_CLIENT));
