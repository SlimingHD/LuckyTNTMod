...
public class HeavensGateEffect extends PrimedTNTEffect{
	...
	public void spawnParticles(IExplosiveEntity ent) {
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() + 0.7f, ent.y(), ent.z(), 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() - 0.7f, ent.y(), ent.z(), 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x(), ent.y(), ent.z() + 0.7f, 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x(), ent.y(), ent.z() - 0.7f, 0, 0.1f, 0);
		
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() + 0.6f, ent.y(), ent.z() + 0.6f, 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() - 0.6f, ent.y(), ent.z() - 0.6f, 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() - 0.6f, ent.y(), ent.z() + 0.6f, 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() + 0.6f, ent.y(), ent.z() - 0.6f, 0, 0.1f, 0);
		
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() + 0.3f, ent.y() + 0.5f, ent.z(), 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() - 0.3f, ent.y() + 0.5f, ent.z(), 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x(), ent.y() + 0.5f, ent.z() + 0.3f, 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x(), ent.y() + 0.5f, ent.z() - 0.3f, 0, 0.1f, 0);
		
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() + 0.2f, ent.y() + 0.5f, ent.z() + 0.2f, 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() - 0.2f, ent.y() + 0.5f, ent.z() - 0.2f, 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() - 0.2f, ent.y() + 0.5f, ent.z() + 0.2f, 0, 0.1f, 0);
		ent.level().addParticle(ParticleTypes.SMOKE, ent.x() + 0.2f, ent.y() + 0.5f, ent.z() - 0.2f, 0, 0.1f, 0);
	}
